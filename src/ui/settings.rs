...
use crate::{
    app::{
        state::{HeaderSettingRow, Palette},
        AppState,
    },
...
mod tests {
    ...
    fn settings_tab_row_renders_rightmost_label_without_clipping() {
        // #116 regression: the last tab must still render in full as tabs change.
        ...
        assert!(rendered.contains("header"), "fork header tab missing");
