...
$fakeDir = Join-Path ([System.IO.Path]::GetTempPath()) "zynk-fake-conpty-$([guid]::NewGuid().ToString('N'))"
...
$oldPath = $env:PATH
$oldSession = $env:ZYNK_SESSION
$env:PATH = "$fakeDir;$oldPath"
$env:ZYNK_SESSION = $Session
